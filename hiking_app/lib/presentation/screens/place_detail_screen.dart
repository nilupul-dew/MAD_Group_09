...
//                   DailyForecastStrip(
//                     forecasts:
//                         _generateMockForecasts(), // Replace with real data in future
//                   ),
//                 ],
//               ),
//             ),
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Divider(
              color: Colors.grey, // subtle gray line
              thickness: 0.8, // thin line
              indent: 16, // same horizontal margin as Padding
              endIndent: 16,
            ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(
                          categoryIcons[widget.place.category] ?? Icons.terrain,
                          color:
                              categoryColors[widget.place.category] ??
                              Colors.grey,
                          size: 22,
                        ),
                        const SizedBox(width: 8),
