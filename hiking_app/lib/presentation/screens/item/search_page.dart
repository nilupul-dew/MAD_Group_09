...
import 'package:hiking_app/domain/models/item/gear_item.dart'; // Still using Item as the model
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _fetchAllAndSuggestedGearItems() async {
    try {
      ...
      final QuerySnapshot suggestedSnapshot = await _firestore
  ...
  void _applyFilters() {
    ...
    List<Item> tempFilteredGear = _allGearItems.where((item) {
  ...
  Widget build(BuildContext context) {
    ...
    final bool showInitialContent = _searchController.text.isEmpty &&
        ...
        children: [
          ...
          Padding(
            ...
            child: GridView.count(
              ...
              crossAxisSpacing: 8,
              mainAxisSpacing: 8,
              children: _gearResults // Display the filtered results
                  .map(
                    (item) => GearItemCard(
                      item: item,
                      onTap: () {
