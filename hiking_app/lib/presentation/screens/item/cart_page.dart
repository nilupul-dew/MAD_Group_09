...
import 'package:hiking_app/data/firebase_services/item/cart_firestore_service.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CartCard(
                      ...
                      itemTotalPrice: cartItem.rentPricePerDay *
                          cartItem.quantity *
                          cartItem.rentalDays,
                      startDate: cartItem.startDate,
                      onDecrementQuantity: () => _updateQuantity(
                        cartItem.cartItemId,
                        cartItem.gearItemId,
                        cartItem.quantity - 1,
                        cartItem.name,
                      ),
                      onIncrementQuantity: () => _updateQuantity(
                        cartItem.cartItemId,
                        cartItem.gearItemId,
                        cartItem.quantity + 1,
                        cartItem.name,
