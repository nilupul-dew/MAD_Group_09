...
//   void initState() {
//     super.initState();
//     // Load places on first frame after widget is built
...
//     // Update showHistory immediately on each change
//     setState(() {
//       showHistory = query.isNotEmpty;
//     });
//   }
...
//   Widget _buildSearchHistory(PlaceViewModel viewModel) {
...
//               shrinkWrap: true,
//               children:
//                   viewModel.searchHistory.map((history) {
//                     return ListTile(
...
//                     _onSearch(
//                       value,
//                     ); // This updates the search query in your ViewModel
//                     setState(() {
//                       showHistory =
//                           value
//                               .isNotEmpty; // This toggles showing the search history suggestions
//                     });
//                   },
//                 ),
...
//                         labelStyle: TextStyle(
//                           color:
//                               viewModel.selectedTypes.contains('Hiking Area')
//                                   ? Colors.white
//                                   : Colors.black,
//                         ),
//                         shape: RoundedRectangleBorder(
...
//                         onSelected:
//                             (selected) => _onTypeSelected(selected, 'Campsite'),
//                         selectedColor: const Color.fromARGB(255, 218, 188, 149),
//                         backgroundColor: const Color.fromARGB(
//                           255,
//                           221,
...
//                         labelStyle: TextStyle(
//                           color:
//                               viewModel.selectedTypes.contains('Campsite')
//                                   ? Colors.white
//                                   : Colors.black,
//                         ),
//                         shape: RoundedRectangleBorder(
