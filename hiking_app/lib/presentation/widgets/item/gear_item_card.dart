...
import 'package:hiking_app/domain/models/item/gear_item.dart'; // Ensure this path is correct
...
class GearItemCard extends StatelessWidget {
  ...
  String get _cardImageUrl {
    ...
    if (item.image.isNotEmpty) {
      ...
      print(
          'DEBUG: GearItemCard - Image URL (default placeholder): $selectedUrl');
    }
    return selectedUrl;
  }
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                errorBuilder: (context, error, stackTrace) {
                  print(
                      'DEBUG: GearItemCard - Image loading error for URL: $_cardImageUrl - Error: $error');
                  return Container(
                    height: 120,
